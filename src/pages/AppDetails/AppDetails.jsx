      ...
      <div className=" container mx-auto px-5">
        <div className="flex flex-col md:flex-row items-start gap-15 mb-12">
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row text-[#001931] flex-wrap gap-4 mb-6">
              <div className="text-center  items-center mr-2">
                <div className="flex justify-center">
                  <img src={Downloads} alt="" className=" bg-none w-10 h-10" />
                </div>
              ...
              <div className="text-center  items-center ml-8">
                <div className="flex justify-center">
                  <img src={ratings} alt="" className=" bg-none w-10 h-10" />
                </div>
              ...
              <div className="text-center items-center ml-10">
                <div className="flex justify-center">
                  <img src={reviewss} alt="" className=" bg-none w-10 h-10" />{" "}
                </div>
